 ...
 * @author alexr
 */
@WebServlet(name = "datosCaja", urlPatterns = {"/datosCaja"})
public class datosCaja extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("vercaja.jsp");
