 ...
 * @author alexr
 */
@WebServlet(name = "datosDetalle", urlPatterns = {"/datosDetalle"})
public class datosDetalle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("verdetalle.jsp");
